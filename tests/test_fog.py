...
def test_project_agent_state_includes_owned_allied_and_adjacent_cities_with_masking() -> None:
    projected = project_agent_state(_match_state(), player_id="player_1")
...
def test_project_agent_state_is_deterministic_and_does_not_mutate_input() -> None:
    ...
    first_projection = project_agent_state(match_state, player_id="player_1")
    second_projection = project_agent_state(match_state, player_id="player_1")
